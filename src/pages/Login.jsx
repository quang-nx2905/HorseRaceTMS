...
function Login() {
    ...
    useEffect(() => {
        ...
        if (errorParam) {
            Promise.resolve().then(() => setError(errorParam));
        }
    }, [location]);
        ...
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 bg-white flex items-center justify-center p-8 lg:p-16">
                <div className="w-full max-w-[420px]">
                    ...
                    {/* Mobile logo */}
                    <Link to="/" className="flex items-center gap-3 mb-10 lg:hidden" aria-label="Back to home">
